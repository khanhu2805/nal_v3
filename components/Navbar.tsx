...
const Navbar = () => {
    ...
    //console.log(session.user.name)
        if (session && session.user && session.user.name !="admin") {
            ...
            return  (
                <>
                <div className='flex bg-orange-100 h-fit w-screen py-2 items-center shadow-md relative'>
                        <a className='flex-col ml-40'href='/'>
                            <img src='/assets/logo.png' className='h-10 w-10' alt = 'logo'/>
                            <span className='text-black font-bold text-lg'>NAL</span>
                        </a>
                    <div className='ml-40'>
                        <div className='flex space-x-12'>
                            <Link href='/product' className='text-black font-bold text-lg hover:text-orange-400'>SẢN PHẨM</Link>
                    ...
                    <div className='flex flex-row  absolute right-10'>
                        ...
                        <button onClick={() => signOut()} className='ml-20 text-black hover:text-white p-2 px-4 font-bold text-xl border-solid border-2 border-orange-400 rounded-lg hover:bg-orange-400'>ĐĂNG XUẤT</button>
                    </div>
                </div>
                </>
            )
       ...
       return (
            <div className='flex bg-orange-100 h-fit w-screen py-2 items-center shadow-md relative'>
                ...
                <a href='/sign_in' className='ml-80 text-black hover:text-white p-2 px-4 font-bold text-xl border-solid border-2 border-orange-400 rounded-lg hover:bg-orange-400'>ĐĂNG NHẬP</a>
            </div>
                )
